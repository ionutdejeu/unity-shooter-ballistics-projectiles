...
namespace Assets.ActionGameFramework.Launcher
{
	...
	{
		public abstract void Launch(GameObject enemy, GameObject attack, Transform firingPoint);
		...
		public virtual void Launch(List<GameObject> enemies, GameObject attack, Transform[] firingPoints)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				Launch(enemy,gameObject, firingPoint);
			}
		}
		...
		/// </param>
		/// <param name="firingPoints"></param>
		public virtual void Launch(GameObject enemy, GameObject attack, Transform[] firingPoints)
		{
			 
			Launch(enemy, attack, GetRandomTransform(firingPoints));
		}
